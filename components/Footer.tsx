                ...
                >
                    ...
                    <motion.div variants={itemVariants} className="lg:col-span-4">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <motion.a whileHover={{ scale: 1.1, y: -4 }} href="https://wa.me/965 552 37906⁩" target="_blank" rel="noreferrer" className="w-11 h-11 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:bg-[#25D366] hover:text-white hover:border-[#25D366] transition-all shadow-lg">
